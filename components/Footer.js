...
const Footer = () => {
  return (
    <>
      <div className="snap-start  bottom-0  w-full  text-[#B6A694]  flex items-center justify-center ">
        <div className="max-w-7xl w-full h-full flex justify-center ">
          <div className="w-full relative  mx-4  h-full flex flex-col  items-center  py-2 ">
            <div className="border-t border-[#B6A694] w-full py-2 flex items-center justify-between">

              <div className="divide-x divide-[#B6A694] flex gap-3  h-full justify-start items-center">
                <div className="flex justify-start items-center">
                  <p className="text-[#B6A694] text-xs pr-4 ">
                ...
                <p className=" text-xs pl-3 cursor-pointer underline ">
                  Disclaimer
                </p>
                <p className=" text-xs pl-3 cursor-pointer underline">
                  Privacy Policy
              ...
              <div>
                <p className="text-[#B6A694] text-xs text-right">
