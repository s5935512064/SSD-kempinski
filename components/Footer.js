...
const Footer = () => {
  return (
    <>
      <div className="absolute  w-full  text-[#B6A694]  flex items-center justify-center ">
        <div className="max-w-7xl w-full h-full flex justify-center   origin-top ">
          <div className="w-full relative  mx-4  h-full flex flex-col  items-center  py-2 ">
            <div className="py-4 w-full  flex flex-col sm:flex-row md:items-center gap-2 ">
              <p className="text-[#B6A694] text-xs sm:text-sm font-light  ">
            ...
            <div className="border-t-[1px] border-white w-full py-2 flex justify-between">
              <p className="text-[#B6A694] text-xs sm:text-sm font-light w-full text-left">
                Copyright © 2022 Siam Sindhorn Co., Ltd. All rights reserved.
              </p>

              <p className="text-[#B6A694] text-xs sm:text-sm  text-right font-light underline cursor-pointer w-1/2">
                Privacy Policy
              </p>
            </div>
          </div>
